	   ...
	   draw: {
		   toolbar: {
			   ...
			   buttons: {
				   ...
				   marker: 'Поставити маркер',
				   circlemarker: 'Поставити круглий маркер'
			   }
		   },
		   handlers: {
			   circle: {
				   tooltip: {
					   start: 'Клікніть та перетягніть для малювання кола.'
				   },
				   radius: 'Радіус'
			   },
			   circlemarker: {
				   tooltip: {
					   start: 'Клікніть на карту, щоб поставити маркер.'
				   }
			   },
			   marker: {
				   tooltip: {
			   ...
			   polygon: {
				   tooltip: {
					   ...
					   cont: 'Клікніть, щоб продовжити малювати фігуру.',
			   ...
			   polyline: {
				   ...
				   tooltip: {
					   ...
					   cont: 'Клікніть, щоб продовжити малювати лінію.',
					   end: 'Клікніть на останню точку, щоб завершити лінію.'
				   }
			   },
			   rectangle: {
				   tooltip: {
					   start: 'Клікніть та перетягніть для малювання прямокутника.'
				   }
			   },
			   simpleshape: {
				   tooltip: {
	   ...
	   edit: {
		   toolbar: {
			   actions: {
				   ...
				   cancel: {
					   title: 'Скасувати редагування, відхилити всі зміни',
					   text: 'Скасувати'
				   },
				   clearAll: {
		   ...
		   handlers: {
			   edit: {
				   tooltip: {
					   text: 'Перетягніть маркери або точки для редагування об\'єктів.',
					   subtext: 'Натисніть скасувати, щоб відмінити зміни.'
				   }
			   },
			   remove: {
				   tooltip: {
					   text: 'Клікніть на об\'єкт для видалення.'
				   }
			   }
		   }
	   }
